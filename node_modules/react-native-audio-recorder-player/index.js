...
(function (OutputFormatAndroidType) {
    ...
    OutputFormatAndroidType[OutputFormatAndroidType["UNUSED"] = 10] = "UNUSED";
    OutputFormatAndroidType[OutputFormatAndroidType["OGG"] = 11] = "OGG";
...
(function (AudioEncoderAndroidType) {
    ...
    AudioEncoderAndroidType[AudioEncoderAndroidType["OPUS"] = 7] = "OPUS";
    ...
    function AudioRecorderPlayer() {
        ...
        this.startRecorder = function (uri, audioSets, meteringEnabled) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this._isRecording) return [3 /*break*/, 4];
                        this._isRecording = true;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, RNAudioRecorderPlayer.startRecorder(uri !== null && uri !== void 0 ? uri : 'DEFAULT', audioSets, meteringEnabled !== null && meteringEnabled !== void 0 ? meteringEnabled : false)];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3:
                        error_1 = _a.sent();
                        this._isRecording = false;
                        throw error_1;
                    case 4: return [2 /*return*/, 'Already recording'];
                }
            });
        }); };
        /**
         ...
         * @returns {Promise<string>}
         */
        this.setPlaybackSpeed = function (playbackSpeed) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, RNAudioRecorderPlayer.setPlaybackSpeed(playbackSpeed)];
            });
        }); };
        /**
