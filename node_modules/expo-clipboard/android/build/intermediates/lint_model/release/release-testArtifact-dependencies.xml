<dependencies>
  <compile
      roots=":@@:expo-clipboard::release,:@@:expo-modules-core::release,androidx.core:core-ktx:1.12.0@aar,org.jetbrains.kotlinx:kotlinx-coroutines-core-jvm:1.6.4@jar,org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.4@jar,org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.8.21@jar,androidx.core:core:1.12.0@aar,androidx.lifecycle:lifecycle-runtime:2.5.1@aar,androidx.versionedparcelable:versionedparcelable:1.1.1@aar,androidx.arch.core:core-common:2.1.0@jar,androidx.lifecycle:lifecycle-common:2.5.1@jar,androidx.collection:collection:1.1.0@jar,androidx.annotation:annotation-jvm:1.7.1@jar,androidx.annotation:annotation-experimental:1.3.0@aar,org.jetbrains.kotlin:kotlin-stdlib:1.9.23@jar,org.jetbrains.kotlin:kotlin-stdlib-jdk7:1.9.23@jar,org.jetbrains:annotations:13.0@jar">
    <dependency
        name=":@@:expo-clipboard::release"
        simpleName="host.exp.exponent:expo-clipboard"/>
    <dependency
